...
{/*INTERFACE DE DADOS BASEADO NO BANCO DE DADOS SIMULADO */}
...
const CharacterCard: React.FC<CharacterCardProps> = ({ character }) => {
  ...
  const hasHalfStar = character.rating - fullStars >= 0.5;{/*casa decimal maior ou igual a 0.5 ganha estrela inteira */}
    ...
    <CardContainer isExpanded={isExpanded}>
      ...
      <DescriptionContainer isExpanded={isExpanded}>
        ...
        <MoreDetails isExpanded={isExpanded}>
          <p>Aparições</p> 
          <List>{/*mapeando o array e inserindo lista de aparições */}
      ...
      </DescriptionContainer>{/*ToggleExpand : gatilho para expandir (botão ver detalhes) */}
    </CardContainer>
  );
};
